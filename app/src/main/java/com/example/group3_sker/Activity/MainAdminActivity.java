...
public class MainAdminActivity extends AppCompatActivity {
    ...
    private void setupBottomNavigation() {
        ...
        chatBtn.setOnClickListener(v -> {
            startActivity(new Intent(MainAdminActivity.this, UserListActivity.class));
        });
        ...
        call.enqueue(new Callback<List<Product>>() {
            ...
            public void onResponse(Call<List<Product>> call, Response<List<Product>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Toast.makeText(MainAdminActivity.this, "Failed to fetch products", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<List<Product>> call, Throwable t) {
                Toast.makeText(MainAdminActivity.this, "Network error. Please try again later.", Toast.LENGTH_SHORT).show();
            }
        });
    }
